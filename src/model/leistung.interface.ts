...
export const createLeistung = (leistung: RestLeistung): ILeistung => ({
    ...
    modulBearbeitungsdauerVorhanden: !!leistung.modulBearbeitungsdauer.beschreibung.length,
    modulFachlicheFreigabeVorhanden: !!leistung.modulFachlicheFreigabe,
    modulFristVorhanden: !!leistung.modulFrist.beschreibung.length,
    modulKostenVorhanden: !!leistung.modulKosten.beschreibung.length,
